...
const LockedOverlay = ({ title, description, requiredPlan = 'pro' }) => {
    ...
    return (
        <div className="absolute inset-0 bg-slate-500/[0.03] [0.03] backdrop-blur-[12px] rounded-2xl flex flex-col items-center justify-center z-[50] overflow-hidden group">
            {/* Subtle inner reflection/glare effect */}
            <div className="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent pointer-events-none" />

            <div className="relative text-center px-6 max-w-sm backdrop-blur-md bg-white/40  p-8 rounded-[2rem] shadow-2xl border border-white/40  transition-all duration-500 hover:scale-[1.02]">
                ...
                <p className="text-[13px] leading-relaxed text-slate-600  mb-6 font-medium px-2">{description}</p>
