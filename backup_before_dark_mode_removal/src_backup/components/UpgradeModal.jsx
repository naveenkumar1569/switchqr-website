...
const UpgradeModal = ({ isOpen, onClose, message, title = "Upgrade Required" }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
            <div className="relative w-full max-w-md mx-4 bg-surface-light dark:bg-surface-dark rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                ...
                <div className="p-6">
                    ...
                    <div className="bg-primary/5 dark:bg-primary/10 rounded-lg p-4 mb-6 border border-primary/20">
                        <p className="text-sm font-semibold text-primary dark:text-purple-400 mb-2">Upgrade to unlock:</p>
                    ...
                    <div className="flex gap-3">
                        <button
                            onClick={onClose}
                            className="flex-1 px-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 text-slate-700 dark:text-slate-300 font-semibold hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
                        >
                            Cancel
                        </button>
                        <button
