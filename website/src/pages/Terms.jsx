...
const Terms = () => {
    ...
    const navLinkClass = (id) =>
        `flex items-center gap-3 px-3 py-2 rounded-lg transition-colors text-sm ${activeSection === id
            ...
            : 'hover:bg-gray-100 text-text-muted font-medium'
        }`;
    ...
    return (
        <div className="bg-background-light text-text-main font-display antialiased min-h-screen">
                ...
                <div className="flex flex-col lg:flex-row gap-12">
                    ...
                    <aside className="hidden lg:block lg:w-1/4">
                        <div className="sticky top-24 space-y-8">
                            <div>
                                <h1 className="text-sm font-bold text-text-muted uppercase tracking-widest mb-4">On this page</h1>
                    ...
                    <div className="lg:w-3/4 max-w-3xl">
                        {/* Page Heading */}
                        <div className="mb-10">
                            <h1 className="text-4xl sm:text-5xl font-black text-text-main leading-tight mb-4 tracking-tight">Terms of Service</h1>
                        ...
                        <div className="mb-12 p-6 rounded-xl border border-primary/20 bg-primary/5 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                            <div className="flex-1">
                                <p className="text-lg font-bold text-text-main mb-1">Agreement of Terms</p>
                        ...
                        <article className="prose prose-slate max-w-none">
                            <p className="text-text-muted leading-8 mb-8">
                            ...
                            <section className="mb-12 scroll-mt-24" id="terms-1">
                                <h2 className="text-2xl font-bold text-text-main mb-6 flex items-center gap-3">
                                    <span className="flex items-center justify-center size-8 rounded-lg bg-gray-100 text-primary text-sm font-bold">1</span>
                                    What SwitchQR Provides
                                </h2>
                                <div className="space-y-4 text-text-muted leading-8">
                            ...
                            <section className="mb-12 scroll-mt-24" id="terms-2">
                                <h2 className="text-2xl font-bold text-text-main mb-6 flex items-center gap-3">
                                    <span className="flex items-center justify-center size-8 rounded-lg bg-gray-100 text-primary text-sm font-bold">2</span>
                            ...
                            <section className="mb-12 scroll-mt-24" id="terms-3">
                                <h2 className="text-2xl font-bold text-text-main mb-6 flex items-center gap-3">
                                    <span className="flex items-center justify-center size-8 rounded-lg bg-gray-100 text-primary text-sm font-bold">3</span>
                                    Acceptable Use
                                </h2>
                                <div className="space-y-4 text-text-muted leading-8">
                            ...
                            <section className="mb-12 scroll-mt-24" id="terms-4">
                                <h2 className="text-2xl font-bold text-text-main mb-6 flex items-center gap-3">
                                    <span className="flex items-center justify-center size-8 rounded-lg bg-gray-100 text-primary text-sm font-bold">4</span>
                                ...
                                <div className="space-y-4 text-text-muted leading-8">
                                    ...
                                    <div className="p-5 bg-gray-50 rounded-lg border-l-4 border-primary italic">
                            ...
                            <section className="mb-12 scroll-mt-24" id="terms-5">
                                <h2 className="text-2xl font-bold text-text-main mb-6 flex items-center gap-3">
                                    <span className="flex items-center justify-center size-8 rounded-lg bg-gray-100 text-primary text-sm font-bold">5</span>
                            ...
                            <section className="mb-12 scroll-mt-24" id="terms-6">
                                <h2 className="text-2xl font-bold text-text-main mb-6 flex items-center gap-3">
                                    <span className="flex items-center justify-center size-8 rounded-lg bg-gray-100 text-primary text-sm font-bold">6</span>
                            ...
                            <section className="mb-12 scroll-mt-24" id="terms-7">
                                <h2 className="text-2xl font-bold text-text-main mb-6 flex items-center gap-3">
                                    <span className="flex items-center justify-center size-8 rounded-lg bg-gray-100 text-primary text-sm font-bold">7</span>
                            ...
                            <section className="mb-12 scroll-mt-24" id="terms-8">
                                <h2 className="text-2xl font-bold text-text-main mb-6 flex items-center gap-3">
                                    <span className="flex items-center justify-center size-8 rounded-lg bg-gray-100 text-primary text-sm font-bold">8</span>
                            ...
                            <section className="mb-12 scroll-mt-24" id="terms-9">
                                <h2 className="text-2xl font-bold text-text-main mb-6 flex items-center gap-3">
                                    <span className="flex items-center justify-center size-8 rounded-lg bg-gray-100 text-primary text-sm font-bold">9</span>
                                    Data and Privacy
                                </h2>
                                <div className="space-y-4 text-text-muted leading-8">
                            ...
                            <section className="mb-12 scroll-mt-24" id="terms-10">
                                <h2 className="text-2xl font-bold text-text-main mb-6 flex items-center gap-3">
                                    <span className="flex items-center justify-center size-8 rounded-lg bg-gray-100 text-primary text-sm font-bold">10</span>
                            ...
                            <section className="mb-12 scroll-mt-24" id="terms-11">
                                <h2 className="text-2xl font-bold text-text-main mb-6 flex items-center gap-3">
                                    <span className="flex items-center justify-center size-8 rounded-lg bg-gray-100 text-primary text-sm font-bold">11</span>
                                    Termination
                                </h2>
                                <div className="space-y-4 text-text-muted leading-8">
                            ...
                            <section className="mb-12 scroll-mt-24" id="terms-12">
                                <h2 className="text-2xl font-bold text-text-main mb-6 flex items-center gap-3">
                                    <span className="flex items-center justify-center size-8 rounded-lg bg-gray-100 text-primary text-sm font-bold">12</span>
                            ...
                            <section className="mb-12 scroll-mt-24" id="terms-13">
                                <h2 className="text-2xl font-bold text-text-main mb-6 flex items-center gap-3">
                                    <span className="flex items-center justify-center size-8 rounded-lg bg-gray-100 text-primary text-sm font-bold">13</span>
                                    Indemnification
                                </h2>
                                <div className="space-y-4 text-text-muted leading-8">
                            ...
                            <section className="mb-12 scroll-mt-24" id="terms-14">
                                <h2 className="text-2xl font-bold text-text-main mb-6 flex items-center gap-3">
                                    <span className="flex items-center justify-center size-8 rounded-lg bg-gray-100 text-primary text-sm font-bold">14</span>
                            ...
                            <section className="mb-12 scroll-mt-24" id="terms-15">
                                <h2 className="text-2xl font-bold text-text-main mb-6 flex items-center gap-3">
                                    <span className="flex items-center justify-center size-8 rounded-lg bg-gray-100 text-primary text-sm font-bold">15</span>
                                    Contact
                                </h2>
                                <div className="space-y-4 text-text-muted leading-8">
            ...
            <a href="#" className="fixed bottom-8 right-8 z-50 p-3 bg-white rounded-full shadow-lg border border-gray-200 text-text-muted hover:text-primary transition-all active:scale-95">
