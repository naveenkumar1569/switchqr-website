export const stories = [
    ...
    },
    {
        ...
        title: 'How Stripe optimized payment-link distribution with dynamic QR codes',
        company: 'Stripe',
        category: 'Fintech',
        brandLogo: 'https://cdn.simpleicons.org/stripe',
        image: '/images/cases/stripe_payments.png',
        heroImage: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDlCE3IxpAL9qmCJrbeJ2UgzTlOgnd7BlfABZxi4_bK7qWQsFf98tTaRvQ2-Z-TVwWyMuyyNPrsXv_55hI4jEg5j205JxnRwGQU_d-TjNGs-miZwhrt1BN7-M4HF8bA_myWta5Hs18kBPmUGL2jGMv7Cib2fmvPfVUqto-6iOg23JKAmpsr2KvliU8igG1c_d_29FFJiDHlrXfWC7N-b9pKAo3lroj_Z1V1ZqIGa5EiSacgJOE2Ovfx5eDMe49HzE5dI4CXJ2aM4is',
        description: "Bridging the gap between physical commerce and digital payments. See how Stripe leveraged dynamic routing to create seamless, instant checkout flows everywhere.",
        challenge: "As payment infrastructure evolved, static payment links printed on physical collateral were rapidly becoming obsolete. Merchants using Stripe needed a way to update pricing, product availability, or redirect customers to different regional checkout flows without re-issuing physical marketing materials. \n\nThe inability to modify the destination of a printed QR code meant that thousands of payment touchpoints became dead ends whenever a campaign ended or a product went out of stock. \n\n• Static payment links becoming obsolete post-campaign. \n• Lost revenue due to friction in correcting out-of-stock flows. \n• Lack of real-time attribution for offline-to-online transactions.",
        solution: "Stripe integrated SwitchQR's API directly into their merchant dashboard, enabling dynamic payment routing for millions of users. This allowed merchants to generate a single QR code that could route customers to different checkout sessions based on time of day, inventory status, or user location. \n\nThe integration provided a robust layer of flexibility, ensuring that a physical scan always resolved to an active, optimized payment intent. \n\n**Dynamic Routing** \nRoute scans to specific checkout sessions via API. \n\n**Instant Updates** \nModify payment links in real-time without reprints.",
        result: "The shift to dynamic QR codes unlocked enhanced checkout flexibility and granular real-time attribution. Merchants saw a 15% improvement in checkout speed as customers were directed to pre-filled, context-aware payment pages. \n\nWith over 1 million monthly dynamic scans now processed through the system, the reliability of offline-to-online transactions has increased dramatically. Engagement with physical payment links tripled, proving that reducing friction at the start of the funnel leads to significantly higher conversion rates.",
        quote: "SwitchQR has become an essential layer in our offline strategy. It bridges physical commerce and digital payments seamlessly, allowing us to maintain the agility of software even in hardware environments.",
        author: "Elena Rostova",
        role: "Product Lead, Stripe",
        authorImage: 'https://lh3.googleusercontent.com/aida-public/AB6AXuC_ejEa_uBIhlAQ0nR97k88adRk5nyFkEZ1zZ-2XahZg7DQCWqMiPzPlcDzPFnSELJur1tZmurqUf3QHV-y-rlU5_RiI7GRPYut-zAXH7EJ-f7J7622iO8pZyFWcJqddovF6AQKNmvD8ruN0r3EA_CrTeeKa0Y0KD9kyL9RydTHNOvZ9iZtwSv0_VfAC1yRXgioFnhwzxGoxVoBKPs_m_MS6D7jASdBpOV7OOKNiS3hu67q79zO7oQEdvpVaiDKNgnVNSwjBnZ35Bw',
        metrics: [
            { value: '15%', label: 'Checkout Speed', subtext: 'Faster payment flow' },
            { value: '3x', label: 'Link Engagement', subtext: 'Vs static printed URLs' },
            { value: '1M+', label: 'Monthly Scans', subtext: 'Across partner locations' }
        ],
        integrations: ['Stripe API', 'AWS', 'Salesforce']
    }
];
